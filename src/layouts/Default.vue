    ...
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          ...
          <g-link v-else to="/" class="text-white hover:text-gray-600">Home</g-link>
        </div>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:mail@marcoschneekluth.de" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/mschneekluth" target="_blank" class="text-white hover:text-gray-400">
