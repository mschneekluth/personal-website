...
const serverAssets = [{"baseName":"server","dir":"/Users/marco/Documents/Coding/personal-website/server/assets"}];
...
storage.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/.nuxt/pinceau/theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marco/Documents/Coding/personal-website/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9Xdi7LBlcu = (function(nitro) {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/marco/Documents/Coding/personal-website/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _sneZmj = defineEventHandler(async (event) => {
...
const _2wxOjK = defineEventHandler(async (event) => {
...
const _6fl2aX = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_gzMjQD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_gzMjQD, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _sneZmj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _sneZmj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _sneZmj, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _2wxOjK, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _6fl2aX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _6fl2aX, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _6fl2aX, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_gzMjQD, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/marco/Documents/Coding/personal-website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/marco/Documents/Coding/personal-website/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
